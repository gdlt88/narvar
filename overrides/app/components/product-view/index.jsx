...
// Import Promise Delivery utility from cartridge-mirrored module
...
const ProductView = forwardRef(
    (
        ...
        // Hardcoded product ID for testing pickup functionality
        const HARDCODED_PICKUP_PRODUCT_ID = '25553417M'
        const isHardcodedPickupProduct =
            product?.id === HARDCODED_PICKUP_PRODUCT_ID ||
            product?.master?.masterId === HARDCODED_PICKUP_PRODUCT_ID
                            ...
                            <Box>
                                {showDeliveryOptions && (
                                    <>
                                        ...
                                        {/* Zip Code Delivery Estimate Section - Only show when Ship to Address is selected */}
                                        {!pickupInStore && (
                                            <Box mb={4} p={4} bg="gray.50" borderRadius="md">
                                                <Text fontWeight={600} mb={3}>
                                                    ...
                                                    <FormattedMessage
                                                        ...
                                                        id="product_view.label.enter_zip"
                                                    />
                                                </Text>
                                                <HStack spacing={2} mb={2}>
                                                    <Input
                                                        placeholder={intl.formatMessage({
                                                            ...
                                                            id: 'product_view.placeholder.zip_code'
                                                        })}
                                                        value={zipCode}
                                                        onChange={(e) => {
                                                            // Only allow numeric input for US ZIP codes
                                                    ...
                                                    <Button
                                                        ...
                                                        isDisabled={!zipCode || zipCode.length < 5}
                                                        onClick={() => {
                                                    ...
                                                    >
                                                        <FormattedMessage
                                                            ...
                                                            id="product_view.button.check_delivery"
                                                        />
                                                    </Button>
                                                </HStack>
                                                {estimatedDelivery && (
